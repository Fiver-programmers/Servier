...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "信息管理",
   	                 "menus": [
   	                     
   	                  {"menuid": "13", "menuname": "班级管理", "icon": "icon-database", "url": "<%= __APP__%>/Obj!meijing"},
   	                  	     
   	      {"menuid": "17", "menuname": "考试管理", "icon": "icon-database", "url": "<%= __APP__%>/Obj!lianxi"},
   	   {"menuid": "18", "menuname": "资料管理", "icon": "icon-database", "url": "<%= __APP__%>/Obj!xinwen"},
  
   	                 ]},

   

   	   	           {"menuid": "1", "icon": "icon-magic", "menuname": "讨论管理",
   	   	   	                 "menus": [
   	   	   	                     {"menuid": "12", "menuname": "讨论列表", "icon": "icon-database", "url": "<%= __APP__%>/Posts!posts"}
   	   	   	                 ]},
