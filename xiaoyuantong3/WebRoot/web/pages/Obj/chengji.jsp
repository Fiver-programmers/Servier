    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '课程', width: 100, field: 'course', sortable: true},
                {title: '分数', width: 100, field: 'score', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
<div id="managerDialog" class="easyui-dialog" title="成绩管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                <th width="30%" align="right"><label>课程：</label></th>
                <td width="60%" colspan="1">
            ...
            <tr>
                <th width="30%" align="right"><label>分数：</label></th>
                <td width="60%" colspan="1">
                    <input id="score" name="obj.score" class="easyui-validatebox"
                           style="width:300px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
                           validType="length[0,100]"/>
                </td>
            </tr>
