...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Obj!getList?type=9",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
        ...
        columns: [
            [
                ...
                {title: '班级', width: 100, field: 'title', sortable: true},
...
<div id="managerDialog" class="easyui-dialog" title="课表管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="type" name="obj.type" value="9"/>
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>班级：</label></th>
			...
			<tr>
                <th width="30%" align="right"><label>课表图片：</label></th>
                <td colspan="" width="30%">
