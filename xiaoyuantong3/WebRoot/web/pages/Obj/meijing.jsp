...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Obj!getList?type=2",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
...
<div id="managerDialog" class="easyui-dialog" title="信息管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="type" name="obj.type" value="2"/>
