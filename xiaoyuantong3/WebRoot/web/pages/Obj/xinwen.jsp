...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Obj!getList?type=7",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
...
<div id="managerDialog" class="easyui-dialog" title="资料管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="type" name="obj.type" value="7"/>
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
			...
			<tr>
                <th width="30%" align="right"><label>图片：</label></th>
                <td colspan="" width="30%">
